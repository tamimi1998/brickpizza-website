...
export function HeroOvenExperience() {
  ...
  return (
    <section
      ref={sectionRef}
      id="hero"
      className="relative h-[420vh] w-full bg-[#0a0503]"
    >
        ...
        <div className="relative z-[4] flex h-full w-full flex-col items-center justify-center px-6 pt-16">
          ...
          >
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-4">
              <a
                href="#menu"
                className="group relative overflow-hidden rounded-full px-8 py-3.5 text-sm font-semibold tracking-wide text-[#1a0c06] shadow-[0_0_32px_rgba(255,140,66,0.35)] transition-transform hover:scale-[1.03] active:scale-[0.99]"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-amber-200 via-orange-300 to-amber-500 opacity-100 transition-opacity group-hover:opacity-100" />
                <span className="absolute inset-0 opacity-0 mix-blend-overlay transition-opacity group-hover:opacity-100">
                  <span className="absolute -inset-full rotate-12 bg-gradient-to-r from-transparent via-white/40 to-transparent transition-transform duration-700 group-hover:translate-x-full" />
                </span>
              ...
              <a
                ...
                className="rounded-full border border-amber-400/40 bg-black/30 px-8 py-3.5 text-sm font-semibold tracking-wide text-amber-50 backdrop-blur-md transition-all hover:border-orange-300/70 hover:bg-black/45 hover:shadow-[0_0_28px_rgba(255,160,90,0.25)]"
              >
                Order Online
              </a>
              <a
                href="#location"
                className="rounded-full border border-white/10 bg-white/5 px-8 py-3.5 text-sm font-semibold text-white/90 backdrop-blur-sm transition-all hover:border-amber-300/40 hover:bg-white/10"
              >
                Visit Brick Pizza
              </a>
            </div>
